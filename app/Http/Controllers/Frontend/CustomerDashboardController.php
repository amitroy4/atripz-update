...
class CustomerDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.dashboard.dashboard',compact('divisions','districts','postOffices','categories'));
    }
    ...
    public function customerBillingUpdate(Request $request, string $id)
    {
        ...
        $request->validate([
            ...
            'b_district' => 'required|string',
            'b_area' => 'required|string',
    ...
    public function newShipping(Request $request)
    {
        ...
        $request->validate([
            ...
            's_district' => 'required|string',
            's_area' => 'required|string',
        ]);
