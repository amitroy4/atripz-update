...
class OrderController extends Controller
{
    ...
    public function order_details(Request $request)
    {
        $orderid = $request->id;
        // $order = Order::find($orderid);
        $order = Order::with('order_item')->find($orderid);
        ...
        foreach ($orderItems as $orderItem) {
            ...
            $product->color = $color;
            $product->size = $size;
            $product->lens_type = $orderItem->lens_type;
            $product->lens_price = $orderItem->lens_price;
            $product->prescription_image = $orderItem->prescription_image;
