                    ...
                    <div class="widget-taber-content p-30 ">
                        <div class="padding_eight_all bg-white">
                            ...
                            <form method="POST" action="{{ route('customer.registration') }}">
                                ...
                                <div class="mb-2">
                                    <button type="submit" class="btn btn-primary w-50 m-auto" name="submit">Register</button>
                                </div>
                            </form>
                            ...
                            <div class="text-muted text-center">Already have an account?
                                <a href="#" data-bs-target="#login" data-bs-toggle="modal" data-bs-dismiss="modal">Sign In</a></div>
