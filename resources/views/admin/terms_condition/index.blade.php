            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <table id="" class="table table-bordered table-responsive" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                <td >{{ $terms_condition->title ?? 'edit title' }}</td>
                                <td >{!! $terms_condition->description ?? 'No description available' !!}</td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="d-flex justify-content-end">
                        <a href="#" class="btn btn-sm font-sm rounded btn-warning edit" data-bs-toggle="modal"
                            data-bs-target="#termscondition" data-aboutus-id="{{ $terms_condition->id ?? '' }}">
    ...
    <div class="modal fade" id="termscondition" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('terms_condition.update') }}" method="POST">
                    @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-md-12 mb-2">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="Type a Title" value="{{ $terms_condition->title ?? '' }}">
                            </div>
                            <div class="col-md-12 mb-2">
                                <label for="summernote" class="form-label">Description<span
                                        class="text-danger">*</span></label>
                                <textarea placeholder="Type here" class="form-control description" id="summernote" rows="15" name="description">{!! $terms_condition->description ?? 'No description available' !!}</textarea>
                            </div>
