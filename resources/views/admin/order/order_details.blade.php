                        ...
                        <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ $product->lens_type }} </td>
                                        <td> {{ $product->lens_price }} </td>
                                        <td>
                                            <a href="{{ asset('storage/'.$product->prescription_image) }}" target="_blank" class="me-3"><i class="fas fa-eye"></i></a>
                                            <a class="text-dark" href="{{ asset('storage/'.$product->prescription_image) }}" download="{{ basename($product->prescription_image) }}"><i class="fas fa-download"></i></a>
                                        </td>
                                        <td class="text-end"> ৳{{($product->price * $product->quantity)+$product->lens_price}} </td>
                                    </tr>
                                    @endforeach
                                    <tr>
                                        <td colspan="8">
                                            <hr>
                                            @php
                                                $totalLensPrice = $order->order_item->sum('lens_price');
                                                $subtotal = $order->subtotal + $totalLensPrice;
                                                $grandTotal = $order->total + $totalLensPrice;
                                                $due = $order->total_due + $totalLensPrice;
                                            @endphp
                                            <article class="float-end">
                                                <dl class="dlist">
                                                    <dt>Subtotal:</dt>
                                                    <dd id="subtotal">৳{{ $subtotal }}</dd>
                                                </dl>
                                                <dl class="dlist">
                                                    <dt>Shipping cost:</dt>
                                                ...
                                                <dl class="dlist">
                                                    <dt>Grand total:</dt>
                                                    <dd> <b class="h5" id="g_total">৳{{$grandTotal}}</b> </dd>
                                                </dl>
                                                <dl class="dlist">
                                                    <dt>Paid :</dt>
