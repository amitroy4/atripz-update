        ...
        <form id="contactinfoUpdateFrom">
            ...
            <div class="modal-body">
                <div class="row gx-3">
                    ...
                    <div class="col-lg-12 col-md-12 mb-2">
                        <label for="officehour" class="form-label">Office Hour <span class="text-danger">*</span></label>
                        <input required type="text" class="form-control" placeholder="Opening Hour/ Office Hour" name="officehour" id="officehour">
                    </div>

                    <div class="col-lg-12 col-md-12 mb-2">
                        <label for="google_map" class="form-label">Google Map <span class="text-danger">*</span></label>
                        <textarea required class="form-control" placeholder="Google Map Embed Link" name="google_map" id="google_map" rows="4"></textarea>
                    </div>
