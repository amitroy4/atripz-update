            ...
            <tbody id="productBody">
                ...
                <tr>
                   ...
                   <td>{{$product->raw_price}}</td>
                    ...
                    <td>
                        <a href="{{ route('product.colorWiseImage', $product->id) }}" class="btn btn-md rounded font-sm">Image</a>
                    </td>
                    @can('update product')
                    <td>
                    ...
                    <td class="text-end">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                @can('update product')
                                {{-- <a class="dropdown-item" href="{{route('products.specification', $product->id)}}">Specification</a> --}}
