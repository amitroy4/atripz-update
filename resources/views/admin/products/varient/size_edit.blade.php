                ...
                <form class="row g-3">
                    <div class="col-md-12 mb-2">
                        <div class="form-group floating-label">
                            <label for="sizename" class="form-label">Storage Name<span class="text-danger">*</span></label>
                        <input type="text" class="form-control " id="size_name" name="size_name" required>
                        </div>
                    </div>
                    <div class="col-md-12 mb-2">
                        <label for="validationDefault01" class="form-label">Storage<span class="text-danger">*</span></label>
