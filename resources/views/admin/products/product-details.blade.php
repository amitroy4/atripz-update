                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                <div class="detail-info">
                                    ...
                                    <div class="short-desc">
                                        ...
                                        <ul class="product-more-infor mt-10">
                                            ...
                                            <li><span>{{$overview->overview_name}}</span> {{$overview->overview_value}}
                                            </li>
                                            @endforeach
                                    ...
                                    <div class="attr-detail attr-size">
                                        ...
                                        <ul class="list-filter size-filter font-small">
                                            ...
                                            <li><a href="#"
                                                    class="{{ $size->size ? 'active' : '' }}">{{$size->size}}</a></li>
                                            @endforeach
                                        ...
                                        <div class="col-lg-6">
                                            <div class="product_sort_info font-xs">
                                                <ul class="product-meta font-xs color-grey">
                                                    <li class=""><strong>SKU:</strong> <a href="#">{{$product->sku}}</a>
                                                    </li>
                               ...
                               <li><strong>Availability:</strong><span class="in-stock ml-5">{{$product->stock}} Items In Stock</span></li>
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <li class=""><i class="fi-rs-crown mr-5"></i>{{ $extrainfo->warrenty_type ?? 'No warranty' }}
                                  </li>
                                  <li class=""><i class="fi-rs-refresh mr-5"></i> {{ $extrainfo->return_policy ?? 'Not Available' }}</li>
                                  <li><i class="fi-rs-credit-card mr-5"></i> {{ $extrainfo->delivery_type === 1 ? 'Cash on Delivery Not available' : 'Cash on Delivery available' }}
                                  </li>
                               </ul>
                                </div>
                                <!-- Detail Info -->
