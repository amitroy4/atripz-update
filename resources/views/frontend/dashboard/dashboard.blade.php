...
<form method="post" action="{{ route('customer.logout') }}">
    ...
    <main class="main">
        ...
        <section class="mt-20" style="margin-top: 50px">
            <div class="container">
...
<script>
   $(document).ready(function () {
        ...
        console.log(divisionsData); // Check if the data for divisions is loaded
        console.log(districtsData); // Check if the data for districts is loaded
        console.log(postcodesData); // Check if the data for postcodes is loaded

        $('#b_division').show();
        // When a division is selected
        $('.division').change(function () {
            var selectedDivisionId = $(this).val();
            console.log('Division changed:', selectedDivisionId); // Debugging line
        ...
        $('.district').change(function () {
            ...
            console.log('District changed:', selectedDistrictId); // Debugging line
        ...
        function updateDropdown(dropdownId, options) {
            ...
            console.log(options); // Log the filtered options to see if the data is correct
        ...
        function updateDropdownArea(dropdownId, options) {
            ...
            console.log(options); // Log the filtered options for Area/Postoffice
