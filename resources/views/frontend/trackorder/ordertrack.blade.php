...
<main class="main" style="padding-top:180px">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body track_search">
                                    <div class="search-menu" style="width: 100%">
                                        ...
                                        <input type="text" class="form-control " name="" id="order_number" placeholder="Track id: GG24-0000">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response && response.order ) {
                        ...
                        var statusIcons = {
                            pending: 'fa-solid fa-basket-shopping',
