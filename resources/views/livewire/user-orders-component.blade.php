                            ...
                            @if ($order != null)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @foreach ($order->order_item as $key => $orderItem)
                                        @php
                                            $color = DB::table('colors')->where('id', $orderItem->color_id)->first();
                                        @endphp
                                        @if($color != null)
                                            <ul class="list-filter color-filter">
                                                <li class="active">
                                                    <a href="#">
                                                        <div class="border border-1 rounded" style="background-color: {{$color->color_code}}; width:20px; height:20px;"></div>
                                                    </a>
                                                </li>
                                            </ul>
                                        @else
                                            <p>No color found for this item.</p>
                                        @endif
                                    @endforeach
                                    ...
                                    <td class="text-center order_status_action" >
                                        ...
                                        <a href="#" data-order-id="{{ $order->id }}" class="action-btn order_return" data-bs-toggle="tooltip" data-bs-placement="right" title="Return"><i class="fa-solid fa-reply"></i></a>
                                        <a href="#" id="order_cancel" data-order-id="{{ $order->id }}" class="action-btn" data-bs-toggle="tooltip" data-bs-placement="right" title="Cancel"> <i class="fa-solid fa-circle-xmark"></i></a>
                                    </td>
                                    @endif
