      ...
      <div class="col-lg-12 mb-4">
          <div class="card  mb-3" >
              <div class="card-header d-flex justify-content-between">
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#profile_modal" class="card-icon"><i class="fa-solid fa-pen-to-square"></i></a>
              </div>
      ...
      <div class="col-lg-6 mb-4">
          <div class="card  mb-3" >
              <div class="card-header d-flex justify-content-between">
                ...
                <a href="#" data-bs-toggle="modal" data-bs-target="#billing_modal" class="card-icon"><i class="fa-solid fa-pen-to-square"></i></a>
                </div>
              <div class="card-body text-primary">
          ...
          <div class="card  mb-3" >
              <div class="card-header d-flex justify-content-between">
                ...
                <div class="shipping-action-btn">
                  ...
                  <a href="#" data-bs-toggle="modal" data-bs-target="#modify_shipping_modal" class="card-icon p-2"><i class="fa-solid fa-pen-to-square"></i></a>
                  @else
