                ...
                <div class="card-body text-primary">
                    <form action="{{url('customer/userNameUpdate/'.$user->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="login_identifier" id="login_identifier"  class="form-control" placeholder="Email/Phone Number">
                ...
                <div class="card-body text-primary">
                    <form action="{{url('customer/customerAuth_update/'.$user->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="old_password" id="old_password" value="" class="form-control" placeholder="Old Password">
                            @error('old_password')
                        ...
                        <div class="mt-2 mb-2">
                            ...
                            <input type="password" name="c_password" id="c_password" value="" class="form-control" placeholder="Confirm Password" required oninput="validateMatching()">
